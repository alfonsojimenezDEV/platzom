...
export default function platzom(str) {
    ...
    if (length >= 10) {
        ...
        const secondHalf = translation.slice(Math.round(length / 2)) //al no indicar el segundo parámetro en slice se entiende que es hasta el final
    ...
    if(str == reverse(str)) { //Es un palíndromo
        return minMay(str)
    }
